/* tests/nc_int_types/signed/nc_ptr_i64/test_nc_ptr_i64.c */

/*
    SPDX-License-Identifier: MIT
    Copyright (c) 2026 Nico Erdmann
    Tests for 'nc_ptr_i64'.
*/
...
int main(void) {
    nc_i64 val_a = nc_new_i64(10);
    nc_i64 val_b = nc_new_i64(5);
    nc_i64 val_zero = nc_new_i64(0);
    nc_i64 val_max = nc_new_i64(NC_I64_MAX);
    
    nc_ptr_i64 ptr_a = nc_new_ptr_i64(val_a);
    nc_ptr_i64 ptr_max = nc_new_ptr_i64(val_max);
    nc_ptr_i64 ptr_null = {.ptr = NULL};
    ...
    nc_free_ptr_i64(res_add);
    nc_free_ptr_i64(res_sub);
    nc_free_ptr_i64(res_mul);
    nc_free_ptr_i64(res_div);
    nc_free_ptr_i64(res_div_zero);
    nc_free_ptr_i64(res_null);
    nc_free_ptr_i64(res_overflow);
