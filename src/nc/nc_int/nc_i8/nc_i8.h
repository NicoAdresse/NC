/* src/nc/nc_int/nc_i8/nc_i8.h */

/*
    SPDX-License-Identifier: MIT
    Copyright (c) 2026 Nico Erdmann
    Header file for the primitive datatype 'nc_i8'.
*/
...
static inline nc_i64 nc_i8_convert_to_i64(nc_i8 primitive) { return nc_new_i64(primitive.val); }
...
static inline nc_u64 nc_i8_convert_to_u64(nc_i8 primitive) { return nc_new_u64(primitive.val); }

/* nc_convert_i8_to_libc_primitive */
static inline int nc_i8_convert_to_int(nc_i8 primitive) { return primitive.val; }
static inline int8_t nc_i8_convert_to_int8_t(nc_i8 primitive) { return primitive.val; }
static inline uint8_t nc_i8_convert_to_uint8_t(nc_i8 primitive) { return primitive.val; }
static inline int16_t nc_i8_convert_to_int16_t(nc_i8 primitive) { return primitive.val; }
static inline uint16_t nc_i8_convert_to_uint16_t(nc_i8 primitive) { return primitive.val; }
static inline int32_t nc_i8_convert_to_int32_t(nc_i8 primitive) { return primitive.val; }
static inline uint32_t nc_i8_convert_to_uint32_t(nc_i8 primitive) { return primitive.val; }
...
/* Checked Modulo -> nc_i8 */
static inline nc_i8 nc_checked_mod_i8(nc_i8 number_one, nc_i8 number_two, int is_zero_denominator_allowed) {
    if (number_two.val == 0) {
        if (!is_zero_denominator_allowed) {
            send_zero_denominator_error_msg(IS_SIGNED, (int64_t)number_one.val, (int64_t)number_two.val);
            return (nc_i8){.val = 0};
